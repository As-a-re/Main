...
const Hymnals = () => {
  ...
  return (
    <div className="bg-[black] h-[100vh] w-[100vw]">
      <div className="hidden sm:block bg-[#27173a] h-[30vh] w-[25vw] rounded-[0.8rem]">
      ...
      <div className="hidden sm:block bg-[#27173a] h-[67vh] w-[25vw] mt-[1rem] rounded-[0.8rem]">
          <p className="text-[white] pt-[1rem] ml-[3rem] font-bold">Your Library</p>
        </div>
    
    <div className="bg-gradient-to-b from-violet-600 to-black-600  h-[100vh] md:w-[74vw] w-[100vw] overflow-y-auto  rounded-[0.8rem] md:mt-[-100vh] md:ml-[26vw]">
        <div className="bg-[#27173a] md:w-[72.8vw] w-[100vw] h-[10vh] flex items-center rounded-[1rem]">
    ...
    {showDiv && (
      ...
      <div className="bg-[#27173a] h-[30vh] w-[40vw] rounded-[0.8rem] ml-[0vw] mt-[0vh]">
      <img src='../images/back1.jpg' alt='bg' onClick={handleClick} className="h-[5vh] w-[5vw] ml-[1vw] mt-[1vh] "></img>
              <p className="text-[white] pt-[1rem] ml-[3rem]">MUSIC</p>
              <p className="text-[white] mt-[2rem] ml-[3rem]">HOME</p>
              <p className="text-[white] mt-[2rem] ml-[3rem]">SEARCH</p>
            </div>
            <div className="bg-[#27173a] h-[70vh] w-[40vw] mt-[1vh] ml-[0vw] rounded-[0.8rem]">
                <p className="text-[white] pt-[1rem] ml-[3rem] font-bold">Your Library</p>
              </div></div>
    )}
        ...
        <h1 className='text-[white] ml-[1rem] mt-[1.5rem] md:text-4xl text-3xl font-bold'>HYMNALS</h1>

        <div className='bg-[#c89df0] md:h-[10vh] h-[10vh] md:w-[70vw] w-[100vw] md:ml-[2vw] ml-[0vw] mt-[3vh]'>
        ...
        <img src='../images/play.jpg' alt='play' className='md:h-[5vh] h-[5vh] md:w-[5vw] w-[9vw] md:ml-[60vw] ml-[82vw] md:mt-[-5vh] mt-[-6vh]'></img>
